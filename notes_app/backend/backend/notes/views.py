...
def notes(request, id=None):
    ...
    if request.method == 'GET':
        try:
            ...
            return Response({'detail': 'Oops, something went wrong!'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
        ...
        try:
            note = get_object_or_404(Note, id=id, author=request.user)  # Use the id from the URL
